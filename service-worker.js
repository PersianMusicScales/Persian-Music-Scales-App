/* Persian Music Scales PWA service worker — reliable microphone permission + right floating recorder v5.4 */
"use strict";

const CACHE_VERSION = "v14-reliable-permission-right-recorder";
