/* =========================================================
   Persian Music Scales — Audio Analyzer UI + integration v5.2 — direct floating recorder + normalized loop playback
...
(() => {
  ...
  function setLanguage(language) {
    ...
    if (!state.selectedCandidate && elements.quickFinderHelp) {
      elements.quickFinderHelp.textContent = dictionary.quickHoldHint;
    }
